...
<body>
	...
	<!-- <div class="container">
		<div class="row mt50 pt50">
			<div class="coppl-md-4"><a id="btn3" class="btn btn-lg btn-success">Demo 3</a></div>
		</div>
	</div> -->
	<section class="content wrapper">

		<h1>欢迎注册家教系统</h1>
		<p class="description">学生注册信息</p>

		<div class="subscription_form clearfix">
			<div>
				<form action="reg" method="post">
					<tr>
						<input type="name" name="cusName" id="name" placeholder="请输入姓名">
                    </tr>
                    <tr>
						<input type="name" name="cusPwd" id="pw1" placeholder="请输入密码">
                    </tr>
                    <tr>
						<input type="name" name="pwd2" id="pw2" placeholder="确认密码" onkeyup="validate()"><span id="tishi"></span>
                    </tr>
                    <tr>
						<input type="name" name="cusTel" id="telephone" placeholder="输入你的电话">
                    </tr>
                    <tr>
						<input type="name" name="cusSex" id="telephone" placeholder="输入你的性别">
                    </tr>
                    <tr>
						<input type="name" name="cusGrade" id="photo" placeholder="请输入你的年级">
                    </tr>
                    <tr>
						<input type="name" name="cusSchool" id="sex" placeholder="所读学校">
                    </tr>
                    <tr>
						<input type="name" id="cusBirthday" placeholder="出生日期">
                    </tr>
